...
namespace JuniperMigration
{
    ...
    public class JuniperConverter : VendorConverter
    {
        ...
        public override void ExportManagmentReport()
        {
            ...
            juniperAnalizStatistic.CalculateRules(_cpPackages, _cpNatRules);
            ...
            using (var file = new StreamWriter(VendorManagmentReportHtmlFile))
            {
                ...
                file.WriteLine($"   <tr><td style='font-size: 14px; color: Black;'></td> <td style='font-size: 14px;'></td> <td style='font-size: 14px;'></td> <td style='font-size: 14px;'></td> <td style='font-size: 14px;'>- ANY in Source: {juniperAnalizStatistic._rulesServicesutilizingServicesAnyDestinationCount} </td></tr>");
                ...
                file.WriteLine($"   <tr><td style='font-size: 14px; color: Black;'>Stealth Rule</td> <td style='font-size: 14px;'>{ChoosePict(juniperAnalizStatistic.StealthServicesRulePercent, 5, 25)}</td> <td style='font-size: 14px;'>{juniperAnalizStatistic._stealthServicesRuleCount}</td> <td style='font-size: 14px;'>{juniperAnalizStatistic.StealthServicesRulePercent.ToString("F")}%</td> <td style='font-size: 14px;'>Found</td></tr>");
                file.WriteLine($"   <tr><td style='font-size: 14px; color: Black;'>Cleanup Rule</td> <td style='font-size: 14px;'>{ChoosePict(juniperAnalizStatistic.CleanupServicesRulePercent, 5, 25)}</td> <td style='font-size: 14px;'>{juniperAnalizStatistic._cleanupServicesRuleCount}</td> <td style='font-size: 14px;'>{juniperAnalizStatistic.CleanupServicesRulePercent.ToString("F")}%</td> <td style='font-size: 14px;'>Found</td></tr>");
                file.WriteLine($"   <tr><td style='font-size: 14px; color: Black;'>Uncommented Rules</td> <td style='font-size: 14px;'>{ChoosePict(juniperAnalizStatistic.UncommentedServicesRulesPercent, 100, 100)}</td> <td style='font-size: 14px;'>{juniperAnalizStatistic._uncommentedServicesRulesCount}</td> <td style='font-size: 14px;'>{juniperAnalizStatistic.UncommentedServicesRulesPercent.ToString("F")}%</td> <td style='font-size: 14px;'>Comment rules for better tracking and change management compliance.</td></tr>");
                file.WriteLine($"   <tr><td style='font-size: 14px; color: Black;'>Optimization Potential</td> <td style='font-size: 14px;'>{ChoosePict(juniperAnalizStatistic.OptimizationServicesPotentialPercent, 5, 25)}</td> <td style='font-size: 14px;'>{juniperAnalizStatistic._optimizationServicesPotentialCount}</td> <td style='font-size: 14px;'>{juniperAnalizStatistic.OptimizationServicesPotentialPercent.ToString("F")}%</td> <td style='font-size: 14px;'></td></tr>");
                file.WriteLine("</table>");
                file.WriteLine("</body>");
                file.WriteLine("</html>");
            }
