...
namespace CiscoMigration
{
    ...
    public class CiscoConverter : VendorConverter
    {
        ...
        public override void ExportManagmentReport()
        {
            ...
            ciscoAnalizStatistic.CalculateRules(_cpPackages, _cpNatRules);
            ...
            using (var file = new StreamWriter(VendorManagmentReportHtmlFile))
            {
                ...
                file.WriteLine($"   <tr><td style='font-size: 14px; color: Black;'>Unused Network Objects</td> <td style='font-size: 14px;'>{ChoosePict(ciscoAnalizStatistic.UnusedNetworkObjectsPercent, 5, 25)}</td> <td style='font-size: 14px;'>{ciscoAnalizStatistic._unusedNetworkObjectsCount}</td> <td style='font-size: 14px;'>{ciscoAnalizStatistic.UnusedNetworkObjectsPercent.ToString("F")}%</td> <td style='font-size: 14px;'>Consider deleting these objects.</td></tr>");
                ...
                file.WriteLine($"   <tr><td style='font-size: 14px; color: Black;'>Unused Services Objects</td> <td style='font-size: 14px;'>{ChoosePict(ciscoAnalizStatistic.UnusedServicesObjectsPercent, 5, 25)}</td> <td style='font-size: 14px;'>{ciscoAnalizStatistic._unusedServicesObjectsCount}</td> <td style='font-size: 14px;'>{ciscoAnalizStatistic.UnusedServicesObjectsPercent.ToString("F")}%</td> <td style='font-size: 14px;'>Consider deleting these objects.</td></tr>");
                ...
                file.WriteLine($"   <tr><td style='font-size: 14px; color: Black;'></td> <td style='font-size: 14px;'></td> <td style='font-size: 14px;'></td> <td style='font-size: 14px;'></td> <td style='font-size: 14px;'>- ANY in Source: {ciscoAnalizStatistic._rulesServicesutilizingServicesAnyDestinationCount} </td></tr>");
                ...
                file.WriteLine($"   <tr><td style='font-size: 14px; color: Black;'>Disabled Rules</td> <td style='font-size: 14px;'>{ChoosePict(ciscoAnalizStatistic.DisabledServicesRulesPercent, 5, 25)}</td> <td style='font-size: 14px;'>{ciscoAnalizStatistic._disabledServicesRulesCount}</td> <td style='font-size: 14px;'>{ciscoAnalizStatistic.DisabledServicesRulesPercent.ToString("F")}%</td> <td style='font-size: 14px;'></td>Check if rules are required.</tr>");
                file.WriteLine($"   <tr><td style='font-size: 14px; color: Black;'>Unnamed Rules</td> <td style='font-size: 14px;'>{ChoosePict(ciscoAnalizStatistic.UnnamedServicesRulesPercent, 5, 25)}</td> <td style='font-size: 14px;'>{ciscoAnalizStatistic._unnamedServicesRulesCount}</td> <td style='font-size: 14px;'>{ciscoAnalizStatistic.UnnamedServicesRulesPercent.ToString("F")}%</td> <td style='font-size: 14px;'></td>Naming rules helps log analysis.</tr>");
                ...
                file.WriteLine($"   <tr><td style='font-size: 14px; color: Black;'>Stealth Rule</td> <td style='font-size: 14px;'>{ChoosePict(ciscoAnalizStatistic.StealthServicesRulePercent, 5, 25)}</td> <td style='font-size: 14px;'>{ciscoAnalizStatistic._stealthServicesRuleCount}</td> <td style='font-size: 14px;'>{ciscoAnalizStatistic.StealthServicesRulePercent.ToString("F")}%</td> <td style='font-size: 14px;'>Found</td></tr>");
                file.WriteLine($"   <tr><td style='font-size: 14px; color: Black;'>Cleanup Rule</td> <td style='font-size: 14px;'>{ChoosePict(ciscoAnalizStatistic.CleanupServicesRulePercent, 5, 25)}</td> <td style='font-size: 14px;'>{ciscoAnalizStatistic._cleanupServicesRuleCount}</td> <td style='font-size: 14px;'>{ciscoAnalizStatistic.CleanupServicesRulePercent.ToString("F")}%</td> <td style='font-size: 14px;'>Found</td></tr>");
                file.WriteLine($"   <tr><td style='font-size: 14px; color: Black;'>Uncommented Rules</td> <td style='font-size: 14px;'>{ChoosePict(ciscoAnalizStatistic.UncommentedServicesRulesPercent, 100, 100)}</td> <td style='font-size: 14px;'>{ciscoAnalizStatistic._uncommentedServicesRulesCount}</td> <td style='font-size: 14px;'>{ciscoAnalizStatistic.UncommentedServicesRulesPercent.ToString("F")}%</td> <td style='font-size: 14px;'>Comment rules for better tracking and change management compliance.</td></tr>");
                file.WriteLine($"   <tr><td style='font-size: 14px; color: Black;'>Optimization Potential</td> <td style='font-size: 14px;'>{ChoosePict(ciscoAnalizStatistic.OptimizationServicesPotentialPercent, 5, 25)}</td> <td style='font-size: 14px;'>{ciscoAnalizStatistic._optimizationServicesPotentialCount}</td> <td style='font-size: 14px;'>{ciscoAnalizStatistic.OptimizationServicesPotentialPercent.ToString("F")}%</td> <td style='font-size: 14px;'></td></tr>");
                file.WriteLine("</table>");
                file.WriteLine("</body>");
                file.WriteLine("</html>");
            }
